...
--
-- Host: localhost    Database: tienda_videojuegos_db
-- ------------------------------------------------------
...
CREATE TABLE `detalle_venta` (
  ...
  PRIMARY KEY (`id_venta`,`id_videojuego`),
  KEY `id_videojuego` (`id_videojuego`),
  CONSTRAINT `detalle_venta_ibfk_1` FOREIGN KEY (`id_venta`) REFERENCES `venta` (`id`),
  CONSTRAINT `detalle_venta_ibfk_2` FOREIGN KEY (`id_videojuego`) REFERENCES `videojuego` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `videojuego` (
  ...
  `plataforma` enum('Playstation 5','PC','Xbox Series','Nintendo Switch') NOT NULL,
...
-- Dump completed on 2025-07-29 20:05:01
